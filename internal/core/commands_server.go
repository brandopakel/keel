...
type ClientBufferStats struct {
	...
	// slow readers and half-sent requests, and separately requests the server
	// parsed and never answered. The second should stay at zero.
	ClosedSlow, ClosedUnanswered uint64
}
